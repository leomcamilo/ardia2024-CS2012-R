...
library(kableExtra)
library(xts)
library(lubridate) # Para extrair o ano
```
...
Segundo Ardia, Guidotti & Kroencke (2024), o spread bid-ask efetivo é uma medida predominante dos custos de transação nos mercados financeiros, representando a distância entre os preços de transação observados e o preço fundamental não observado de um ativo. Este spread reflete a liquidez do mercado, sendo influenciado por fatores como a volatilidade do ativo, a frequência de negociação e a assimetria de informações entre os participantes do mercado. **A mensuração precisa do spread bid-ask é crucial para entender a eficiência do mercado e os custos enfrentados pelos investidores, tendo sido objeto de estudo em abordagens que focam tanto em dados de alta frequência quanto de baixa frequência.**

**Diante da importância deste indicador e da diversidade de metodologias disponíveis para sua estimação, emerge o problema central que orienta esta pesquisa: qual estimador de spread bid-ask baseado em dados de baixa frequência apresenta maior acurácia e robustez quando aplicado ao mercado acionário brasileiro, considerando suas características específicas de liquidez e volatilidade? Esta questão é particularmente relevante no contexto de mercados emergentes, onde os estimadores tradicionais, desenvolvidos e testados predominantemente em mercados maduros, podem não capturar adequadamente as dinâmicas locais de formação de preços e custos de transação. A resposta a este problema tem implicações significativas tanto para a literatura acadêmica sobre microestrutura de mercado quanto para aplicações práticas por investidores, reguladores e gestores de risco que necessitam de ferramentas confiáveis para mensurar custos de transação em diferentes contextos de mercado.**

Com uma capitalização de mercado de 723,5 bilhões de dólares em dezembro de 2024, a B3 (Brasil, Bolsa, Balcão) representa a maior bolsa de valores da América Latina, superando significativamente a Bolsa Mexicana de Valores (417,6 bilhões). Embora expressiva regionalmente, a B3 ainda mantém distância considerável do maior mercado entre os emergentes asiáticos apresentados, o Hong Kong Exchanges and Clearing, que ultrapassou 4,5 trilhões de dólares. A bolsa brasileira demonstrou volatilidade ao longo de 2024, atingindo seu pico em fevereiro (931 bilhões) e experimentando uma queda gradual que resultou em uma redução de 22% até dezembro. Apesar disso, mantém-se à frente de outros mercados emergentes como Indonésia (830,8 bilhões) e Cingapura (647,3 bilhões), evidenciando sua relevância como centro financeiro estratégico além das fronteiras latino-americanas. [^1]

[^1]: Dados obtidos da Federação Mundial de Bolsas (World Federation of Exchanges - WFE), Fevereiro de 2025. Disponível em: <https://focus.world-exchanges.org/issue/february-2025/market-statistics>. Acesso em 29 de abril de 2025.

**Neste cenário de expressiva, porém volátil, capitalização de mercado da B3, o estudo da microestrutura deste mercado torna-se particularmente relevante. A compreensão dos mecanismos de formação de preços, especialmente os custos de transação representados pelo spread bid-ask, é fundamental para investidores que buscam operar neste ambiente. O spread bid-ask, ao refletir tanto a liquidez quanto a assimetria informacional dos ativos negociados, funciona como um termômetro das condições de eficiência do mercado e influencia diretamente as estratégias de investimento. Considerando a importância deste indicador e as características específicas do mercado brasileiro, é essencial dispor de métodos robustos para sua estimação, adaptados às peculiaridades dos mercados emergentes.**

**A literatura acadêmica apresenta lacunas significativas nesse campo, uma vez que os estimadores de spread bid-ask foram tradicionalmente desenvolvidos e calibrados para mercados financeiros maduros, com características distintas dos mercados emergentes. Há pouca validação empírica desses modelos em mercados como o brasileiro, caracterizado por maior volatilidade, negociações infrequentes em diversos ativos e concentração de liquidez em um número limitado de ações. Nesse contexto, a ocorrência da pandemia de COVID-19 proporcionou um "experimento natural" singular para testar a robustez desses estimadores em condições extremas de mercado. Além disso, o surgimento recente do estimador EDGE (Ardia, Guidotti & Kroencke, 2024), que propõe aprimoramentos metodológicos para lidar especificamente com negociações infrequentes, oferece uma oportunidade inédita de análise comparativa que pode contribuir significativamente tanto para o avanço acadêmico quanto para aplicações práticas por profissionais do mercado financeiro brasileiro.**

Apesar dos avanços metodológicos descritos por Corwin (2012) e Ripamonti (2016), há espaço para ampliar a aplicação dessas técnicas especificamente a mercados emergentes. Enquanto muitos estudos têm se dedicado à análise de mercados desenvolvidos, o mercado brasileiro, com suas particularidades de menor liquidez e maior volatilidade, representa um campo fértil para testar a robustez e a aplicabilidade dessas metodologias em diferentes contextos institucionais.
...
**A pesquisa delimita-se à análise de 130 ações listadas na B3, selecionadas com base em critérios rigorosos de liquidez, contemplando títulos dos diferentes segmentos de governança corporativa (Novo Mercado, Nível 2, Nível 1 e segmento Tradicional). O período de análise abrange os anos de 2018 a 2022, estrategicamente dividido em três fases: pré-pandemia (2018-2019), pandemia (2020) e pós-pandemia (2021-2022). Esta segmentação temporal permite avaliar o comportamento dos diferentes estimadores de spread bid-ask em condições de mercado distintas – desde períodos de relativa estabilidade até momentos de extrema volatilidade. A abordagem metodológica contempla a aplicação de três técnicas de estimação baseadas exclusivamente em preços diários (abertura, máxima, mínima e fechamento), tendo como benchmark comparativo os dados oficiais da Bloomberg, considerados referência no mercado financeiro. Este escopo temporal e metodológico possibilita uma análise robusta das particularidades do mercado brasileiro, contribuindo para a literatura sobre microestrutura de mercados emergentes.**
...
1.  **Avaliar o desempenho dos diferentes estimadores de spread bid-ask em grupos de ações com distintos níveis de liquidez, categorizados como alta liquidez (top 30% em volume negociado), média liquidez (40% intermediários) e baixa liquidez (30% inferiores em volume negociado);**

2.  **Analisar a eficácia e robustez dos estimadores em diferentes contextos de volatilidade de mercado, comparando três períodos: pré-pandemia (2018-2019), caracterizado por relativa estabilidade; pandemia (2020), marcado por alta volatilidade e incerteza; e pós-pandemia (2021-2022), período de gradual normalização das condições de mercado;**

3.  **Verificar a proximidade estatística entre as estimativas geradas pelos três métodos e os valores de referência da Bloomberg através de testes de similaridade de distribuição e métricas de erro;**

4.  **Identificar qual metodologia apresenta melhor adaptabilidade às características específicas do mercado acionário brasileiro, considerando suas particularidades como mercado emergente.**
...
O MAE foi selecionado em detrimento do Erro Percentual Absoluto Médio (MAPE) devido às características específicas dos dados de spread bid-ask analisados. Como os spreads podem apresentar valores muito próximos de zero em determinados momentos ou para ativos altamente líquidos, o uso do MAPE poderia resultar em distorções significativas ou valores indefinidos, pois esta métrica envolve divisão pelos valores reais. O MAE, por não depender da magnitude dos valores observados, oferece uma medida mais estável e confiável para a comparação entre os diferentes estimadores em nossa amostra heterogênea. Além disso, o MAE atribui peso igual a todos os erros, independentemente de sua magnitude, oferecendo uma perspectiva alternativa e complementar ao RMSE, que enfatiza erros maiores.
